...
import Blacklogo from '../assets/img/white1.png'
import { Link } from "react-router-dom";

function NavBar() {
  return (
 <>
 <div class="bg-gray-100 font-sans fixed top-0 w-full">
	<div class="bg-white shadow">
    <div class="container mx-auto px-4">
      <div class="flex items-center justify-between py-4">
        <div>
        <p className="font-semibold">COZYRENTALS</p>
        </div>
        ...
        <div class="hidden sm:flex sm:items-center">
          <a href="#" class="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4"><Link to="login">signin</Link></a>
          <a href="#" class="text-gray-800 text-sm font-semibold border px-4 py-2 rounded-lg hover:text-purple-600 hover:border-purple-600"><Link to="signup">SignUp</Link></a>
        </div>
      ...
      <div class="block sm:hidden bg-white border-t-2 py-2">
        <div class="flex flex-col">
          ...
          <div class="flex justify-between items-center border-t-2 pt-2">
            ...
            <a href="#" class="text-gray-800 text-sm font-semibold border px-4 py-1 rounded-lg hover:text-purple-600 hover:border-purple-600"><Link to="signup">signin</Link></a>
          </div>
        </div>
      </div>
    </div>
